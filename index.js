...
// This makes process.env aware of variables defined in that file.
dotenv.config();
...
import { getBaseInputs } from './prompts.js'; // Keep this - we might still need prompts
...
async function loadConfig() {
    ...
    try {
        ...
        if (error.code === 'ENOENT') {
            // Config file not found, this is okay.
...
async function runGenerate(config, enableTranslation) {
     // ... (Implementation unchanged - uses values from config object) ...
